...
const SupportSection = ({ onScheduleClick }) => {
                ...
                <div className="support-card">
                    ...
                    <div className="card-footer-actions">
                        <div className="card-navigation">
                            <button className="nav-arrow" onClick={prevStep}>&lt;</button>
                            <button className="nav-arrow" onClick={nextStep}>&gt;</button>
                        </div>

                        <button onClick={onScheduleClick} className="btn-schedule">Schedule a Free Meeting</button>
                    </div>
                </div>
