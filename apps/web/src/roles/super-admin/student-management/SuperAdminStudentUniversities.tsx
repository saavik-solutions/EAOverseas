...
const SuperAdminStudentUniversities = () => {
    ...
    useEffect(() => {
        const loadApps = () => {
            ...
            // Filter only university applications
            setApplications(savedApps.filter(app => app.type === 'University').reverse());
        };
        loadApps();
    ...
    return (
        <SuperAdminLayout title="University Applications">
                            ...
                            {filteredApps.length > 0 ? (
                                filteredApps.map(app => (
                                    <tr key={app.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="text-sm font-semibold text-slate-700">{app.universityName}</span>
                                        </td>
                                        <td className="px-6 py-4">
...
export default SuperAdminStudentUniversities;
